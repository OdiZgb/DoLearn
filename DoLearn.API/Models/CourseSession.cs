...
public class CourseSession
{
    ...
    public DateTimeOffset  Start { get; set; }   // E.g., 2025-04-20 09:00 AM
    public DateTimeOffset  Finish { get; set; }  // E.g., 2025-04-20 10:30 AM
    public string? MeetingURL { get; set; }  // Nullable reference type
